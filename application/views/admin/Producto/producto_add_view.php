                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo base_url();?>Mantenimiento/Producto_controller/store" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                  ...
                                  <div class="row mb-2">
                                        ...
                                        <div class="form-group col-md-4 <?php echo !empty(form_error("numserie"))? 'has-danger':'';?>">
                                            <label  class="form-control-label" for="numserie">Numero de serie:</label>
                                            <input type="text" class="form-control form-control-danger" id="numserie" name="numserie"
                                            title="Ingrese un numero de serie del producto." value="<?php echo set_value("numserie"); ?>">
                                ...
                                <div class="form-group">
                                     <div class="row mb-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" title="Ingrese el codigo de barra del producto."id="cbarra" name="cbarra">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row mb-2">        
                                        <div class="form-group col-md-4 <?php echo !empty(form_error("preciocompra"))? 'has-danger':'';?>">
                                            ...
                                            <input type="text" title="Ingrese el precio de compra del producto."class="form-control" id="preciocompra" name="preciocompra"
                                ...
                                <div class="form-group">
                                    <div class="row mb-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" title="Seleccione la nacionalidad del producto." name="nacionalidad" id="nacionalidad">
                                                <?php foreach($nacionalidad as $nacionalidad): ?>
                                                    <option value="<?php echo $nacionalidad->IdNacionalidad;?>"
                                ...
                                <div class="form-group">
                                    <div class="row mb-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" title="Seleccione la marca del producto." name="marca" id="marca">
                                ...
                                <div class="form-group">
                                    <div class="row mb-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control"  title="Seleccione la categoria ."name="tipoproducto" id="tipoproducto">
                                                 <?php foreach($tipoproducto as $tipoproducto): ?>
                                                     <option value="<?php echo $tipoproducto->IdTipoProducto;?>"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control"title="Seleccione el proveedor ." name="proveedor" id="proveedor">
                                ...
                                <div class="form-group">
                                    <div class="row mb-2">
                                        ...
                                        <div class="form-group col-md-4 <?php echo !empty(form_error("caracteristicas"))? 'has-danger':'';?>">
                                            ...
                                            <textarea class="form-control form-control-danger" title="Ingrese las caracteristicas."rows="3" placeholder="Enter ..." id="caracteristicas" name="caracteristicas" value="<?php echo set_value("caracteristicas"); ?>"></textarea>
